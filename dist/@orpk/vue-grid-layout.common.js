/*! @orpk/vue-grid-layout - 2.4.4 | (c) 2015, 2023  Gustavo Santos (JBay Solutions) <gustavo.santos@jbaysolutions.com> (http://www.jbaysolutions.com) | https://github.com/jbaysolutions/vue-grid-layout */
module.exports =
...
/*: Layout*/
{
  ...
  if (isUserAction) {
    ...
    fakeItem.x = Math.max(collidesWith.x - itemToMove.w, 0); // fakeItem.y = 0;
