...
<script>
    import {setTopLeft, setTopRight, setTransformRtl, setTransform, isRowFull} from '@/helpers/utils';
...
//                        console.log("### resize => " + event.type + ", lastW=" + this.lastW + ", lastH=" + this.lastH);
                        ...
                        console.log(newSize)
                        if(isRowFull(this.layout.layout,this.y,12) && newSize.width > this.resizing.width) 
